...
%% k-means with dimensionality bias
...
[idxEu,centEu] = kmeans(standPVT,numClusters,'Distance','sqeuclidean');
[idxCB,centCB] = kmeans(standPVT,numClusters,'Distance','cityblock');
...
for j = 5:6
    ...
    for i = 1 : height(PVT)
        ...
        if idx(i) == 1
            scatter3( standPVT(i,1) , standPVT(i,2) , standPVT(i,3) , 'filled' , 'r' );
        elseif idx(i) == 2
            scatter3( standPVT(i,1) , standPVT(i,2) , standPVT(i,3) , 'filled' , 'g' );
        elseif idx(i) == 3
            scatter3( standPVT(i,1) , standPVT(i,2) , standPVT(i,3) , 'filled' , 'b' );
        elseif idx(i) == 4
            scatter3( standPVT(i,1) , standPVT(i,2) , standPVT(i,3) , 'filled' , 'm' );
        elseif idx(i) == 5
            scatter3( standPVT(i,1) , standPVT(i,2) , standPVT(i,3) , 'filled' , 'c'  );
        else
            scatter3( standPVT(i,1) , standPVT(i,2) , standPVT(i,3) , 'filled' , 'y'  );
        end 
        hold on;
    end
    ...
    if j == 5
        title( 'k-means with dimensionality bias' )
    else
        title( 'k-means with dimensionality bias' )
    end
